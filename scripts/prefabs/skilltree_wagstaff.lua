...
local function BuildSkillsData(SkillTreeFns)
    local skills =
    {
        ...
        wagstaff_celestial_possession = {
            ...
            .. ""
            .. "\n"
            .. "Butler: Foods restore 40% HP based on hunger value (day only). Haunting the MK III revives you with FULL HP/sanity/hunger, +100 max HP and 25% damage absorption for 60s."
            .. "\n"
